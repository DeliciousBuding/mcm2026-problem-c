...
| 文档 | 内容 |
|------|------|
| [功能说明.md](docs/功能说明.md) | 功能模块详细说明与输出清单 |
| [算法框架.md](docs/算法框架.md) | 冲奖版算法与论文框架 |
| [图表规范.md](docs/图表规范.md) | 图表设计规范与配色方案 |
| [开发文档.md](docs/开发文档.md) | 开发与调试指南、Git 工作流规范 |
| [题目原文.md](docs/题目原文.md) | 题目原文（英文） |
| [论文冲奖任务清单.md](docs/论文冲奖任务清单.md) | 论文优化任务追踪 |
