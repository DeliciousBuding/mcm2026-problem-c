...
- [ ] **机制指标分布图**：按 season 画 agency/integrity/stability 的箱线/散点（可附录）。
- [ ] **中文图注加强一句权衡解释**：关键图（反事实时间线/DAWS 触发/Pareto）加入括号说明“权衡而非全面最优”。
...
- [ ] **机制指标分布图（可选）**：按 season 输出箱线/散点图并在附录引用（与包 S 同步）。
