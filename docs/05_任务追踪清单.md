...
### Block 5 ??????????
- [ ] **Hard-0?strict feasible ????????????**
  - **simplex**?v_i >= 0 ? sum(v_i)=1??????? eps????? eps??
  - **elimination**????? E???? S?????? max(E) <= min(S) + eps?ties ??????
  - **rank/percent ??**???????????????????? elimination ???????????
  - **??**?strict_feasible_flag ???????? checks ???

- [ ] **Hard-1??????????**
  - **???????**??????? strict feasible ????????????? excluded_from_metrics=1?
  - **????????**?fallback ??? *Audit-Weak* ??????/????????????????
  - **??**?????/HDI/??????? strict feasible ????????????????????
  - **??**?`outputs/audit_week_meta.csv` ?? `strict_feasible_flag`?`used_fallback`?`excluded_from_metrics`?

- [ ] **Hard-2?LP/MILP/Slack ????**
  - **???????**????????? constraint violation slack??? LP slack???????/?????
  - **????????**??????LP/MILP ????????????????????????
  - **??**?????? LP/MILP/optimization ????????????

- [ ] **Hard-3??????????**
  - **???????**?percent/rank ? strict ???? bottom-k?max(E) <= min(S)+eps?
  - **??**???????????????accept_rate ? HDI ???????

- [ ] **Hard-4?temporal smoothness ???????**
  - **???????**??????????????????????????
  - **????????**????temporal smoothness ??????????????????????
  - **??**????????????? posterior/MaxEnt/temporal prior ????????

- [ ] **Hard-5?Rank->share ?? Delta ??**
  - **???????**?Delta ??? tie-breaking ??? 0???????????
  - **????????**?????? Delta??????????????
  - **??**??????????????????

- [ ] **Hard-6?fast vs strict ??? fallback ??**
  - **???????**?strict=?? checks ???fast=?? checks ???strict ???? strict ???>=?????????????
  - **????????**?fast/strict ??????????????????????
...
- [ ] **??C????????????????**
  - `audit_week_meta.csv` ?????seed?n_proposals?n_accept_fast?n_accept_strict?accept_rate_strict?min_violation?max_violation?excluded_from_metrics?
  - ????? eps????????????

### Block 5 ????
- [ ] strict feasible ????eps?ties ???????????
- [ ] ?????????????????????????
- [ ] ????????????????????
- [ ] ????????????????

### Block 5 ????
- [ ] ???? `outputs/audit_week_meta.csv` ? `summary_metrics`?? strict/fallback/???????????
- [ ] ??????strict/fast checks?eps/ties?????????
- [ ] ????????????????
