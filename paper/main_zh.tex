...
\takeaway{我们重建与周淘汰一致的粉丝票可行多面体，并将不确定性传播到反事实规则评估与 DAWS 机制中。}
...
\caption{DAWS 在公平、主权、稳定之间实现更优折中。}
\end{figure}
...
\subsection{规则切换推断}
\takeaway{通过 change-point/HMM 推断规则切换赛季。}
\begin{equation}
