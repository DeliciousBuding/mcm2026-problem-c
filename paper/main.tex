...
\begin{itemize}[leftmargin=2em]
\item \textbf{Consensus (Green).} If Percent and Rank agree, follow Percent (50/50) to preserve viewer agency.
\item \textbf{Conflict (Yellow).} If they disagree, activate judge-save between the two candidates to restore integrity.
