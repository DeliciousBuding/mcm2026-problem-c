...
\begin{figure}[H]
\centering
\includegraphics[width=0.70\linewidth]{figures/fig_mechanism_radar.pdf}
...
\end{subfigure}
\caption{Rule-switch probability with uncertainty.}
\end{figure}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.98\linewidth]{figures/fig_alluvial_finalists.pdf}
\caption{Mechanism choice can alter finalists and champions with nontrivial probability.}
\vspace{0.4em}
\begin{subfigure}[t]{0.49\linewidth}
\centering
\includegraphics[width=\linewidth]{figures/fig_ternary_daws.pdf}
\caption{DAWS on the Pareto surface.}
\end{subfigure}
\hfill
\begin{subfigure}[t]{0.49\linewidth}
\centering
...
\begin{figure}[H]
\centering
\includegraphics[width=0.98\linewidth]{figures/fig_scale_benchmark.pdf}
...
\item \textbf{Mechanism impact:} Rank aggregation increases flips; DAWS improves stability without sacrificing fairness.
