...
\captionof{figure}{Mechanism trade-offs (conflict weeks only, $A=1$; agency = agreement with Percent; integrity = saving the higher judge-score in the conflicting pair).}
\end{minipage}\hfill
\begin{minipage}[t]{0.49\linewidth}
\centering
\includegraphics[width=\linewidth]{figures/fig_mechanism_compare_conflict.pdf}
\captionof{figure}{Mechanism comparison (conflict weeks only, $A=1$; agency = agreement with Percent).}
\end{minipage}
\clearpage
\tableofcontents
\clearpage
