...
DAWS fairness (Kendall $\tau$) & \MetricDAWSFairness \\
...
\begin{figure}[H]
\centering
\includegraphics[width=0.92\linewidth]{figures/fig_mechanism_radar.pdf}
...
Our theoretical framework is LP/MILP-based; however, the production pipeline uses a fast Dirichlet sampler with simplified feasibility checks for speed. We therefore validate the approximation by re-filtering the same proposals with strict feasibility (full elimination constraints) and comparing posterior summaries.
\begin{table}[H]
\centering
\begin{tabular}{@{}ll@{}}
\toprule
...
Fairness shift (percent) & \MetricFastDeltaFair \\
...
\begin{figure}[H]
\centering
\includegraphics[width=0.78\linewidth]{figures/fig_fast_vs_strict.pdf}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.92\linewidth]{figures/fig_uncertainty_heatmap.pdf}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.90\linewidth]{figures/fig_sigma_sensitivity.pdf}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.90\linewidth]{figures/fig_rule_switch.pdf}
\caption{The inferred switch concentrates around Season 28 with residual uncertainty.}
\end{figure}

\begin{figure}[H]
\centering
\includegraphics[width=0.90\linewidth]{figures/fig_rule_switch_ci.pdf}
\caption{Bootstrap uncertainty bands for the rule-switch probability.}
\end{figure}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.90\linewidth]{figures/fig_conflict_map.pdf}
\caption{Eliminations are not always aligned with minimum fan support.}
\end{figure}

\begin{figure}[H]
\centering
\includegraphics[width=0.90\linewidth]{figures/fig_conflict_combo.pdf}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.92\linewidth]{figures/fig_controversy_ridgeline.pdf}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.92\linewidth]{figures/fig_wrongful_heatmap.pdf}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.92\linewidth]{figures/fig_alluvial_finalists.pdf}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.85\linewidth]{figures/fig_ternary_daws.pdf}
\caption{DAWS sits on the Pareto frontier of the trade-off surface.}
\end{figure}

\begin{figure}[H]
\centering
\includegraphics[width=0.86\linewidth]{figures/fig_mechanism_compare.pdf}
\caption{Numeric comparison of fairness, agency, and stability across mechanisms.}
\end{figure}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.90\linewidth]{figures/fig_pro_forest.pdf}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.82\linewidth]{figures/fig_feature_scatter.pdf}
\caption{Points far from the diagonal indicate differing impacts.}
\end{figure}

\subsection{Predictive Add-on: GBDT}
\takeaway{We include a predictive model as a robustness check, not as the main driver analysis.}
We train a gradient-boosted decision tree (GBDT) classifier to predict elimination using forward-chaining validation and report AUC as a sanity check on covariate relevance.
% 预测性能曲线
\begin{figure}[H]
\centering
\includegraphics[width=0.80\linewidth]{figures/fig_auc_forward.pdf}
\caption{Predictive performance is stable and supports the selected covariates.}
\end{figure}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.82\linewidth]{figures/fig_judgesave_curve.pdf}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.80\linewidth]{figures/fig_ppc_summary.pdf}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.90\linewidth]{figures/fig_scale_benchmark.pdf}
